...
# Load data and extract acoustic features
...
# visualization of feature tensors
...
# Feature classification: convert tensor features into logit class probabilities from Wav2Vec model
